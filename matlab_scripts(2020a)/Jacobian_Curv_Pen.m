...
integrand_der = derder_h./(norm_p_d.^2) - 2./(norm_p_d.^4).*dotReal(der_p,der_h).*derder_p ...
    - (dotReal(der_p,derder_h)./(norm_p_d.^4).*der_p + dotReal(der_h,derder_p)./(norm_p_d.^4).*der_p ...
    + dotReal(der_p,derder_p)./(norm_p_d.^4).*der_h - 4./(norm_p_d.^6).*dotReal(der_p,der_h).*dotReal(der_p,derder_p).*der_p);
